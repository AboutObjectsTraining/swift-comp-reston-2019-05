...
// Make changes to eBooksAuthor.swift instead.

import Foundation
import CoreData

open class _eBooksAuthor: ManagedObject
{ 
    public struct Keys {
    ...
    open class var fetchRequest: NSFetchRequest<eBooksAuthor> { return NSFetchRequest(entityName: entityName) }
    ...
    public convenience init?(managedObjectContext: NSManagedObjectContext) {
        guard let entity = _eBooksAuthor.entity(managedObjectContext: managedObjectContext) else { return nil }
